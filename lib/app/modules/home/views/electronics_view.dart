...
class ElectronicsView extends GetView {
  final List<Map<String, String>> flashSaleItems;

  const ElectronicsView({super.key, required this.flashSaleItems});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('ElectronicsView'), centerTitle: true),
            ...
            children: [
              ...
              GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount:
                      screenWidth > 600 ? 3 : 2, // 3 items for larger screens
                  crossAxisSpacing: 10,
                  mainAxisSpacing: 10,
                  childAspectRatio:
                      screenWidth > 600
                          ? 0.6
                          : 0.7, // Adjust aspect ratio based on screen size
                ),
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  ...
                  height:
                      screenWidth > 600
                          ? 120
                          : 100, // Adjust image height for larger screens
