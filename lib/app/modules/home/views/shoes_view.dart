...
class ShoesView extends GetView<HomeController> {
  final List<Map<String, String>> flashSaleItems;

  const ShoesView({super.key, required this.flashSaleItems});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('ShoesView'), centerTitle: true),
